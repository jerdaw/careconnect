...
const SCENARIOS: TestScenario[] = [
  ...
  },
  {
    ...
    expectedServiceNames: [
      ...
      "Lunch by George",
      "AMS Food Bank",
      "Salvation Army Rideau Heights Food Bank",
      "The Good Food Box",
    ],
  ...
  // === HEALTH ===
  {
    ...
    expectedServiceNames: [
      ...
      "Kingston Community Health Centres (KCHC) - Weller Clinic",
    ],
  ...
  },
  {
    ...
    expectedServiceNames: [
      ...
      "Sexual Violence Prevention & Response Coordinator (SVPRC)",
    ],
