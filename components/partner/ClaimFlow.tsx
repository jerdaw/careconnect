      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-6 py-4">
          ...
          <div className="flex items-center gap-2 text-sm text-neutral-500">
            <span
              className={`flex h-6 w-6 items-center justify-center rounded-full border ${step === 1 ? "border-primary-600 bg-primary-50 text-primary-600" : "bg-neutral-100"}`}
            >
              1
            </span>
            <span>{t("step1")}</span>
            ...
            <span
              className={`flex h-6 w-6 items-center justify-center rounded-full border ${step === 2 ? "border-primary-600 bg-primary-50 text-primary-600" : "bg-neutral-100"}`}
            >
              2
            </span>
            <span>{t("step2")}</span>
