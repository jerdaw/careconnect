...
<div className="footer-links">
  ...
  <ul>
    ...
    <li><Link href="mailto:feedback@careconnect.ing">Contact Us</Link></li>
...
Phase 2 of v19.0 Launch Preparation is complete. The platform now has comprehensive, bilingual user-facing documentation that will help users understand and effectively use CareConnect.
