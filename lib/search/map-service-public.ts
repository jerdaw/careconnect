...
export function mapServicePublicToService(service: ServicePublic): Service {
  return {
    ...
    hours_text: service.hours_text ?? undefined,
    hours_text_fr: service.hours_text_fr ?? undefined,
    fees: service.fees ?? undefined,
    eligibility: service.eligibility ?? undefined,
    eligibility_fr: service.eligibility_fr ?? undefined,
    eligibility_notes: service.eligibility_notes ?? service.eligibility ?? undefined,
    eligibility_notes_fr: service.eligibility_notes_fr ?? service.eligibility_fr ?? undefined,
    application_process: service.application_process ?? undefined,
    application_process_fr: service.application_process_fr ?? undefined,
